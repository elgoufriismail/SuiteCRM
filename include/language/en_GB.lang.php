...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    'language_pack_name' => 'English (United Kingdom) - en_GB',
    'moduleList' => array(
        'Home' => 'Home',
...
$app_strings = array(
    ...
    'DEFAULT' => 'Basic', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    'LBL_SORT' => 'Sort',
    ...
    'LBL_EMAIL_MESSAGE_NO' => 'Message no.', // Counter. Message number xx
    ...
    'LBL_CLOSE_BUTTON_TITLE' => 'Close', // As in closing a task
    'LBL_CLOSE_AND_CREATE_BUTTON_LABEL' => 'Close and Create New', // As in closing a task
    'LBL_CLOSE_AND_CREATE_BUTTON_TITLE' => 'Close and Create New', // As in closing a task
    ...
    'LBL_COUNTRY' => 'Country:',
    'LBL_CREATE_BUTTON_LABEL' => 'Create', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    ...
    'LBL_OR' => 'OR',
    'LBL_PANEL_OVERVIEW' => 'Overview', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    'LBL_PANEL_ASSIGNMENT' => 'Other', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    'LBL_PANEL_ADVANCED' => 'More Information', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    ...
    'LBL_SHOW' => 'Show',
    'LBL_STATE' => 'State:', //Used for Case State, situation, condition
...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_CONFIRM_DISREGARD_EMAIL_TITLE' => 'Exit composition?',
    'LBL_CONFIRM_DISREGARD_EMAIL_BODY' => 'Exiting the composition will result in all unsaved changes being lost. Do you want to exit without saving?',
    ...
    'LBL_SUITE_DESC2' => 'This program is free software; you can redistribute it and/or modify it under the terms of the GNU Affero General Public Licence version 3 as published by the Free Software Foundation, including the additional permission set forth in the source code header.',
...
// knowledge base
$app_list_strings['moduleList']['AOK_KnowledgeBase'] = 'Knowledge Base'; // Shows in the ALL menu entries
...
$app_list_strings['aow_operator_list']['Anniversary'] = 'Same date and time';
...
$app_strings['LBL_SUITE_DASHBOARD'] = 'Dashboard'; //Can be translated in all caps. This string will be used by SuiteP template menu actions
...
$app_list_strings['sa_status_list']['Complete'] = 'Complete';
$app_list_strings['sa_status_list']['In_Review'] = 'In Review';
