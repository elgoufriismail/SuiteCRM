...
$mod_strings = array(
    ...
    'LBL_DISABLED_DESCRIPTION' => 'L\'installateur a déjà été exécuté une fois. Il a été désactivé par mesure de sécurité pour une nouvelle exécution. Si vous êtes sûr que vous souhaitez l\'exécuter à nouveau, veuillez modifier (ou ajouter) une variable appelée «installer_locked» avec la valeur «false» dans votre fichier config.php. La ligne devrait ressembler à ceci :',
    ...
    'LBL_REG_CONF_1' => 'Veuillez prendre un moment pour vous inscrire à SuiteCRM. En nous faisant savoir comment votre entreprise souhaite utiliser SuiteCRM, nous pourrons nous assurer que nous livrons toujours le bon produit pour vos besoins internes.',
    'LBL_REG_CONF_2' => 'Votre nom et votre adresse électronique sont les seuls champs obligatoires pour l\'enregistrement. Tous les autres champs sont facultatifs, mais très utiles. Nous ne vendons, louons ou partageons les informations recueillies à aucun tiers.',
    ...
    'ERR_LOG_DIRECTORY_REQUIRED' => 'Le répertoire de journaux est requis si vous souhaitez préciser le vôtre.',
    ...
    'ERR_PERFORM_NO_TCPIP' => '<b>Nous n\'avons pas pu détecter de connexion à internet.</b> Une fois la connexion établie, rendez-vous sur <a href=\\"https://www.suitecrm.com\\">https://www.suitecrm.com</a> pour vous enregistrer auprès de SuiteCRM. En nous informant la manière dont votre entreprise envisage d\'utiliser SuiteCRM, nous pourrons nous assurer que nous fournissons toujours le bon logiciel pour vos besoins internes.',
    'ERR_SESSION_DIRECTORY_NOT_EXISTS' => 'Le répertoire de session n\'est pas un répertoire valide.',
